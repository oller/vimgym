...
export const LevelStatsCard = ({
  ...
  return (
    <div className="flex justify-between text-xs font-medium tracking-wider uppercase mt-3 relative">
      <Tooltip.Provider delayDuration={100}>
        <Tooltip.Root>
          <Tooltip.Trigger asChild>
            <button
              className="flex items-center gap-1 relative group outline-none"
              type="button"
            >
              <svg
