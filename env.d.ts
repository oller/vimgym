...
export type CoercedEnvSchema = {
   ...
   * Supabase anon/public key for client-side access (found in Project Settings > API)  
   * NOTE: These are not secrets  
...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<CoercedEnvSchema, 'VITE_SUPABASE_URL' | 'VITE_SUPABASE_ANON_KEY'>> {}
}
